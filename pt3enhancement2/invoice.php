...
try {
  ...
  $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    $stmt = $conn->prepare("SELECT * FROM tbl_orders_a176172, tbl_staffs_a176172_pt3, tbl_customers_a176172_pt3, tbl_orders_details_a176172 WHERE
      tbl_orders_a176172.fld_staff_num = tbl_staffs_a176172_pt3.fld_staff_num AND
      tbl_orders_a176172.fld_customer_num = tbl_customers_a176172_pt3.fld_customer_num AND
      tbl_orders_a176172.fld_order_num = tbl_orders_details_a176172.fld_order_num AND
      tbl_orders_a176172.fld_order_num = :oid");
...
<div class="col-xs-6 text-center">
  <br>
    <img src="happiness logo.png" width="70%" height="25%" align="left">
</div>
...
<table class="table table-striped table-bordered">
  ...
  $counter = 1;
    ...
    $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
    $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
      $stmt = $conn->prepare("SELECT * FROM tbl_orders_details_a176172,
        tbl_products_a176172_pt3 where 
        tbl_orders_details_a176172.fld_product_num = tbl_products_a176172_pt3.fld_product_num AND
        fld_order_num = :oid");
    $stmt->bindParam(':oid', $oid, PDO::PARAM_STR);
      $oid = $_GET['oid'];
    $stmt->execute();
